        ...
        <div className="pt-4 lg:pt-10">
            <div className="px-[20px] lg:px-[280px]">
                ...
                <div className="flex w-full pt-8 justify-center gap-x-6">
                    ...
                    <button className="w-1/2 text-[#4328EB] flex items-center justify-center gap-x-2 lg:w-fit">View Pricing <span><Image src={BlurArrow} alt='Learn More' /></span></button>
                </div>
            </div>
            <div className='relative flex h-full w-full justify-center'>
                <Image src={Gradient} alt='Gradient'className='min-h-[500px] w-full object-cover lg:h-auto'/>
                <div className='absolute bottom-5 flex w-full flex-col items-center'>
                    <Image src={HeroImage} alt='hero image' className='-ml-4 h-[310px] sm:-mb-28 sm:h-[400px] lg:h-auto xl:w-[70%]'/>
                    
                    <div className='flex w-full flex-col items-center lg:container lg:flex-row lg:px-20 lg:justify-between '>
