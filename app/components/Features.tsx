        ...
        <div className="flex flex-col gap-y-[56px] py-[56px] lg:py-[120px] lg:gap-y-[80px]">
            <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
                ...
                <div className='sm:w-1/2 lg:py-[56px] pr-[56px]'>
                    ...
                    <p className='flex items-center gap-x-2 pt-[24px] font-medium text-[#0085FF] lg:text-[18px]'>Learn More<span><Image src={BlueButton} alt=''/></span></p>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-x-6 sm:flex-row">
                ...
                <div className='sm:w-1/2 lg:py-[56px] pl-[56px]'>
                    ...
                    <p className='flex items-center gap-x-2 pt-[24px] font-medium text-[#00A424] lg:text-[18px]'>Learn More<span><Image src={GreenButton} alt=''/></span></p>
                </div>
            </div>
                ...
                <div className='sm:w-1/2 lg:py-[56px] pr-[56px]'>
                    ...
                    <div className='flex w-full gap-x-[24px] '>
                        <div className='w-1/2 flex flex-col gap-y-3'>
                            <h3 className='text-[20px] font-medium text-[#172026] te'>100+</h3>
                    ...
                    <p className='flex items-center gap-x-2 pt-[24px] font-medium text-[#EB2891] lg:text-[18px]'>Learn More<span><Image src={PinkButton} alt=''/></span></p>
                </div>
            </div>
        </div>
    )
